...
export const Schemas = {
  ...
  createDatabaseRows: z
    .object({
      baseUpdatedAt: optionalString(100),
      rows: z
        .array(
          z.object({
            sourceRowId: z.string().min(1).max(300).optional(),
            cells: z.record(z.string().max(300), z.any()).optional(),
          }),
        )
        .min(1)
        .max(500)
  ...
  deleteDatabaseRows: z
    .object({
      baseUpdatedAt: optionalString(100),
      rowIds: z.array(z.string().min(1).max(300)).min(1).max(1000),
    })
    .passthrough(),
        ...
        .array(
          z
            .object({
              ...
              reviewDue: z.string().max(80).optional(),
