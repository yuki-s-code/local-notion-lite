...
export function getRelationCandidates(prop: WorkspaceDatabase['properties'][number], currentDb: WorkspaceDatabase, allDatabases: WorkspaceDatabase[], pages: PageWithLock[], journals: JournalSummary[], rowId: string): RelationCandidate[] {
