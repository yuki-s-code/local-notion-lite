...
export function TreeItem({ node, depth = 0, currentId, collapsedIds, onToggleCollapse, onOpen, onCreateChild, onCreateFromTemplate, onMovePage, onToggleFavorite, onDuplicatePage, onTrashPage, onReorderPage, onContextMenu, draggedPageId, onDragStart, onDragEnd }: {
  node: PageTreeNode;
  depth?: number;
  currentId?: string;
  ...
  const totalChildCount = countDescendantPages(node);
